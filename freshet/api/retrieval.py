...
DEFAULT_TAU_S = 1800.0       # recency half-weight ~ 21 min; tuned to the demo's incident span
DEFAULT_MIN_SIMILARITY = 0.3  # abstention floor calibrated by eye for MiniLM; not yet revalidated for bge.
